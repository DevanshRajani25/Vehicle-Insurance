# This file is used for making directories(Configuration) in artifact folder
import os
...
# This part is for Data Ingestion
@dataclass
...
# This part is for Data Validation
@dataclass
...
# This part is for Model Training
@dataclass
